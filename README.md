# Projetos com a linguagem Java (Foco em Fundamentos) 
...
- Estudo: Aplicar conceitos relacionados a Lógica de programação, a Orientação a Objetos, métodos Contrutores, métodos GET e SET, ArrayList. 
